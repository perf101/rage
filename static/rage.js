...
function som_page_init() {
  ...
  $(".multiselect").change(function() {
    ...
    if ($(this).prop('value') == "ALL")
      ...
      $("th[name='title_" + $(this).prop('name') + "']").css({'color':'#e95420'});
  });
  ...
  $("#redraw").css('color', '#e95420'); //until a graph is drawn, the Draw/Redraw button should be red
...
function preselect_fields_based_on_params() {
  ...
  for (var param in params) {
    ...
    $("th[name='title_" + param + "']").css({'color':'#e95420'});
  }
